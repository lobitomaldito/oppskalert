          ...
          <div className="grid sm:grid-cols-2 gap-5 max-w-[46rem]">
            {sammenlignOversikt.map((s) => (
              <Link
                ...
                to={s.rute}
                data-reveal
                className="group flex flex-col justify-between rounded-2xl border border-primary/10 bg-primary/[0.03] hover:border-accent/40 transition-colors duration-300 p-7"
              >
                <div>
